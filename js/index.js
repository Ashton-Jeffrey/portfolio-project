    ...
    data.projects.forEach(function (project) {
        portfolioDisplay.innerHTML +=
            ...
            <div class= "flex flex-wrap justify-between"> 
                <h4 class="text-emerald-500 text-lg font-extrabold">${project.title}</h4>
                <div class="flex flex-col"> 
                    <p class="text-xs font-bold">Deliverables</p>
                    <p class="text-sm font-bold">${project.deliverables}</p>
                </div>
                <a class="text-sm font-bold hover:text-emerald-500" href="/portfolio.html#${project.projectno}">View Project</a>
            </div>
